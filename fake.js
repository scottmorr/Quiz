...
function timerStart () {
   const TIME_LIMIT=45;
    ...
    function lastClick () {
        var lastChoice = document.getElementById('choices');
        lastScreen
    ...
    var lastScreen = document.getElementById('questions');
    lastScreen.setAttribute("class", "answer");
    
    
    var finalScreen = document.getElementById('endScreen');
    questionCard.removeAttribute("class");
    document.getElementById("demo").innerHTML = "Hello World!";
    
    
    document.getElementById('correctTab').textContent="Corect";
}
